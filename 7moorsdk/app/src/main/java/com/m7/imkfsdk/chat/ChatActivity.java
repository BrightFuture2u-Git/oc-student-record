...
public class ChatActivity extends MyBaseActivity implements OnClickListener,
    ...
    private Button mChatMore, mChatSetModeVoice,
            mChatSetModeKeyboard;
    TextView chat_tv_convert;
    RelativeLayout chat_tv_back;
    ...
    public void callDialog() {
        final Dialog dialog_call = new Dialog(this, R.style.ActionSheetDialogStyle);
        ...
        dialog_call.setContentView(view);
        Window dialogWindow = dialog_call.getWindow();
...
//    }
    ...
    public void initBottomList() {
        ...
        chat_tv_back = this.findViewById(R.id.relay_back);
        ...
        mChatInput.setOnFocusChangeListener(new OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus) {
//                    mChatEdittextLayout.setBackgroundResource(R.drawable.kf_input_bar_bg_active);
                    mChatEdittextLayout.setBackgroundResource(R.drawable.shap_bg_gray_10);
                } else {
//                    mChatEdittextLayout.setBackgroundResource(R.drawable.kf_input_bar_bg_normal);
                    mChatEdittextLayout.setBackgroundResource(R.drawable.shap_bg_gray_10);
                }
...
//                            .setBackgroundResource(R.drawable.kf_input_bar_bg_active);
                            .setBackgroundResource(R.drawable.shap_bg_gray_10);
...
// 隐藏软键盘
    ...
    public void onClick(View v) {
        int i1 = v.getId();
        if (i1 == R.id.relay_back) {//断开长连接
            handleLogOutOrBackPressed();
        } else if (i1 == R.id.tv_call) {
            callDialog();

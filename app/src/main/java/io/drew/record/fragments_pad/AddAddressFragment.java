...
public class AddAddressFragment extends BaseDialogFragment {
    ...
    public AddAddressFragment(boolean editModel, boolean onlyOneAddress, AddressList.Address address) {
        this.editModel = editModel;
        this.onlyOneAddress = onlyOneAddress;
        this.address = address;
    }

    public AddAddressFragment(int type, boolean editModel, boolean onlyOneAddress, AddressList.Address address) {
        this.type = type;
        this.editModel = editModel;
        this.onlyOneAddress = onlyOneAddress;
        this.address = address;
    ...
    public AddAddressFragment(int type) {
        this.type = type;
    }
    ...
    protected void initData() {
        ...
        addressDataList = FileUtils.getAddressDatas(mContext);
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_address_main:
                SoftKeyBoardListener.hideInput((Activity) mContext);
                showAddressPicker();
...
//                mPicker.showCityPicker();
    ...
    private void showAddressPicker() {
        ...
        if (type == 2) {
            lp.width = (AppUtil.getScreenWidth(getActivity()) - mContext.getResources().getDimensionPixelOffset(R.dimen.dp_44)) / 2;
        } else {
            lp.width = (AppUtil.getScreenWidth(getActivity()) - mContext.getResources().getDimensionPixelOffset(R.dimen.dp_44)) * 2 / 5 + getResources().getDimensionPixelSize(R.dimen.dp_10);
        }

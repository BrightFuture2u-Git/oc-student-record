...
public class UploadMyRecordWorkActivity extends BaseActivity {
    ...
    protected void initData() {
        audioSaveDir = getCacheDir().getAbsolutePath();
        Intent intent = getIntent();
        Bundle bundle = intent.getExtras();
        if (bundle != null) {
            recordsBean = (MyRecordWorks.RecordsBean) bundle.getSerializable("record");
        }
        ...
        if (recordsBean == null) {
            ...
            GlideUtils.loadRoundCornerImg(UploadMyRecordWorkActivity.this, path, iv_choose, 5f);
        ...
        if (requestCode == REQUEST_DRESS) {
            if (resultCode == RESULT_OK) {
                ...
                if (extras != null) {
                    ...
                    GlideUtils.loadRoundCornerImg(UploadMyRecordWorkActivity.this, path, iv_choose, 5f);
                    if (index_choose >= 0 && !TextUtils.isEmpty(name_baby)) {
                        btn_submit.setBackground(getResources().getDrawable(R.drawable.shape_bg_btn_submit));
                        btn_submit.setClickable(true);
                    }
                }
    ...
    @OnClick({R.id.line_choose, R.id.line_add_work, R.id.btn_submit, R.id.tv_reload
    ...
    public void showLectureChooseDialog() {
        ...
        View view = LayoutInflater.from(this).inflate(R.layout.dialog_lecture_choose, null);
        ...
        lp.height = AppUtil.getScreenHeight(this) / 2;
    ...
    public void choosePicDialog() {
        Dialog dialog = new Dialog(this, R.style.ActionSheetDialogStyle);
        View view = LayoutInflater.from(this).inflate(R.layout.dialog_get_picture_type, null);
        ...
        tv_camera.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dialog.dismiss();
                PictureSelector.create(UploadMyRecordWorkActivity.this)
...
//                        .minimumCompressSize(500)// 小于500kb的图片不压缩
    ...
    private void showPre() {
        ...
        intent.setClass(UploadMyRecordWorkActivity.this, WorkDressActivity.class);
    ...
    private void upLoadImg(String imageUrl) {
        ...
        OSSManager.instance().upload(UploadMyRecordWorkActivity.this, stsInfo, getFileName(imageUrl), imageUrl, new OnOssFileUploadListener() {
            @Override
            public void onUploadSuccess(String url) {
                MyLog.e(url + "上传图片成功");
                url_img_oss = url;
    ...
    private void addProduct() {
        ...
        appService.addRecordProduct(body).enqueue(new BaseCallback<>(recordsBean -> {
            cancleLoadingDialig();
            if (recordsBean!=null) {
